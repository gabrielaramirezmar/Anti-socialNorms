...
global characteristics "id_role control1 control2 control3 control4 survey1 gender survey3 related_degree semester survey8 rational survey10 educ_m educ_p situ_financiera stratum"

mat characteristics =J(17,5,.)

tokenize ${characteristics}
...
forvalues j=1/17{
	...
	matrix characteristics [`j',5]= r(N)		
	matlist characteristics
	
}

frmttable using "$Tablas\Descriptivas_final.doc", replace sdec(3) statmat(estadisticas) title("Tabla 1. Estadísticas Descriptivas") ctitles("", "Media", "Mínimo", "Máximo", "SD", "Observaciones") rtitles("Aversión al riesgo" \"Aversión a la ambigüedad" \ "Paciencia" \"Estado en el programa" \ "Mujer" \ "Edad" \ "Leer y escribir" \ "Participacion en asociaciones" \ "No cultivador" \ "Cultivador" \ "Recolector" \ "Cultivador previo al PNIS" \ "Recolector previo al PNIS" \ "Transformador previo al PNIS" \"Comercializador previo al PNIS" \ "Sin relacion previo al PNIS" \ "Hoja de coca/cosecha producida (kg)" \ "Hoja de coca/cosecha comprada (kg)" \ "Pasta base producida por XX kilos de hoja de coca (kg)" \ "Ha Coca" \ "Hoja de coca/cosecha recogida (kg)" \ "Confianza en el gobierno" \ "Probabilidad nula de monitoreo" \"Probabilidad baja de monitoreo"\ "Probabilidad alta de monitoreo" \"Temor nulo a sanciones"\"Temor bajo a sanciones"\ "Temor alto a sanciones"\  "Conocimiento de consecuencias por incumplimiento" \ "Beneficios no son suficientes"  \"Beneficios parcialmente suficientes"\ "Beneficios sí son suficientes"\ "Consecuencia: Extinción"  \ "Consecuencia: Judicialización"  \ "Consecuencia: Retiro del PNIS" \  "Personas en el hogar" \  "Personas menores de 15 en el hogar" \  "Personas mayores de 65 en el hogar" \ "Personas entre 15 y 65 en el hogar" \"Índice de Pobreza Multidimensional 1" \ "Índice de Pobreza Multidimensional 2")
